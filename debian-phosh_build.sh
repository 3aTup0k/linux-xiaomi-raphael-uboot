...
# Install base packages and Phosh desktop (variant-dependent)
chroot rootdir apt install -y bash-completion sudo apt-utils ssh openssh-server nano systemd-boot initramfs-tools chrony curl wget dnsmasq iptables iproute2 "$DESKTOP_VARIANT"
